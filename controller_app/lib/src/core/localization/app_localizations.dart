...
const _englishText = <String, String>{
  ...
  "低速": "Low Speed",
  "体感控制": "Motion Control",
  "体感控制校准": "Motion Control Calibration",
  "RX电量": "RX Battery",
  ...
  "固定位置表示从固定起点开始操控，\n隐藏可变位置表示任意起点开始。":
      "Fixed Position starts from a fixed point.\nVariable Position starts from any point.",
  "固定值": "Fixed Value",
  "基本设置": "Basic Settings",
  "复位/保存": "Reset/Save",
  "多状态": "Multi-State",
  ...
  "左转": "Turn Left",
  "左手": "Left Hand",
  "左手油门": "Left-hand Throttle",
  "单手右边": "Single Right",
  "单手左边": "Single Left",
  "单手右边：右边区域控制油门方向\n单手左边：左边区域控制油门方向\n右手油门：右边区域控制油门\n左手油门：左边区域控制油门":
      "Single right: right area controls throttle and steering.\nSingle left: left area controls throttle and steering.\nRight-hand throttle: right area controls throttle.\nLeft-hand throttle: left area controls throttle.",
  "已连接": "Connected",
  "已配对列表": "Paired list",
  "已配对设备列表": "Paired list",
  "帮助": "Help",
