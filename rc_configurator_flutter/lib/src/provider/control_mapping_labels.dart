...
import 'control_mapping_en_labels.dart';
...
class ControlMappingLabels {
  ...
  static final Map<String, String> _idByEn = controlMappingEnLabels.map(
    (k, v) => MapEntry(v, k),
  );
  ...
  static String displayLabel(String value, Locale locale) {
    ...
    return controlMappingEnLabels[value] ?? value;
  }
